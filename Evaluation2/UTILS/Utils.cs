...
namespace Evaluation2.UTILEMETIER
{
    public class Utils
    {
        ...
        public static void CreateDatabase() => new CreateDatabaseIfNotExists<EfContext>().InitializeDatabase(new EfContext());

        public static void CreateDatabaseWithSample() => new SampleCompteInitializer().InitializeDatabase(new EfContext());
